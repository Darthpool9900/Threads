...
namespace Projeto_8
{
    internal class Grapichs
    {
        ...
        //Construtor
        public Grapichs(DataBase pBaseDeDados)
        {
        ...
        public void ImprimeDadosNaTela(CadastroPessoa pPessoa)
        {
            ...
            Console.WriteLine("Número do documento: " + pPessoa.NumeroDoc);
            Console.WriteLine("Data de nascimento: " + pPessoa.Data);
            Console.WriteLine("Nome da rua: " + pPessoa.NomeRua);
            Console.WriteLine("Número da casa: " + pPessoa.NomeRua);
            Console.WriteLine("");
        }
        ...
        public Resultado_e CadastraUsuario()
        {
            ...
            baseDeDados.addInfo(cadastroUsuario);
            Console.Clear();
        ...
        public void BuscaUsuario()
        {
            ...
            List<CadastroPessoa> listaDePessoaTemp = baseDeDados.Search(temp);
            Console.Clear();
        ...
        public void RemoveUsuario()
        {
            ...
            List<CadastroPessoa> listaDePessoaTemp = baseDeDados.Remove(temp);
            Console.Clear();
            if (listaDePessoaTemp != null)
            {
        ...
        public void IniciaInterface()
        {
            ...
            do
            {
                Console.WriteLine("Digite C para castrar um novo usuário.");
                ...
                switch (temp)
                {
                    case "c":
                        ...
                        if (baseDeDados.Lock() == false)
                        {
                            MostraMensagem("DataBase is offline");
                            break;
                        }
                        else
                        CadastraUsuario();
